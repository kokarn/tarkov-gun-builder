      ...
      <div>
        <div className="gun-wrapper">
          ...
          >
            ...
            {item && (
              <img alt={item.name} loading="lazy" src={item.gridImageLink} />
            )}
            <ItemList
          ...
          <div className="stats-wrapper">
            <StatsLine
              ...
              text={"Ergonomics"}
              temporaryValue={
                item?.itemProperties.Ergonomics + temporaryErgonomicsModifier
              }
            />
            <StatsLine min={0} max={100} value={55} text={"Accuracy"} />
            <StatsLine min={0} max={100} value={55} text={"Sighting range"} />
            <StatsLine
              min={0}
              max={700}
            ...
            <div class="grid-container">
              ...
              <div class="grid-item">
                Caliber
                <div class="grid-item-right">
                  {item?.itemProperties.ammoCaliber.replace("Caliber", "") ||
                    "-"}
                </div>
              </div>
              <div class="grid-item">
                    ...
                    <Slot
                      ...
                      onItemInstalled={(newItem) => {
                        const canMountItems = items.find(
                          (item) => newItem === item.id && item.slots
                        );
                      ...
                      onItemUninstalled={(uninstalledItem) => {
                        setInstalledItems(
                          installedItems.filter(
                            (item) => item.id === uninstalledItem.id
                          )
                        );
                      }}
